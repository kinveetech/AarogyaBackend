...
namespace Aarogya.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260225021533_AddRegistrationFlowEntities")]
    partial class AddRegistrationFlowEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.AadhaarVaultAccessLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OccurredAt")
                        .HasDatabaseName("ix_aadhaar_access_logs_occurred_at");

                    b.HasIndex("ReferenceToken")
                        .HasDatabaseName("ix_aadhaar_access_logs_reference_token");

                    b.HasIndex("ReferenceToken", "OccurredAt")
                        .HasDatabaseName("ix_aadhaar_access_logs_reference_token_time");

                    b.ToTable("access_audit_logs", "aadhaar_vault");
                });
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.AadhaarVaultRecord", b =>
                {
                    ...
                    b.Property<byte[]>("DemographicsJson")
                        .HasColumnType("bytea")
                    ...
                    b.HasIndex("AadhaarSha256")
                        .IsUnique()
                        .HasDatabaseName("ux_aadhaar_records_sha256");

                    b.HasIndex("ReferenceToken")
                        .IsUnique()
                        .HasDatabaseName("ux_aadhaar_records_reference_token");

                    b.ToTable("aadhaar_records", "aadhaar_vault");
                });
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("OverlapExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("overlap_expires_at");
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.ConsentRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "Purpose", "OccurredAt")
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.DoctorProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<byte[]>("ClinicAddress")
                        .HasColumnType("bytea")
                        .HasColumnName("clinic_address_encrypted");

                    b.Property<byte[]>("ClinicOrHospitalName")
                        .HasColumnType("bytea")
                    ...
                    b.Property<byte[]>("MedicalLicenseNumber")
                        .IsRequired()
                        .HasColumnType("bytea")
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_doctor_profiles_user_id");
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.LabTechnicianProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<byte[]>("LabLicenseNumber")
                        .HasColumnType("bytea")
                        .HasColumnName("lab_license_number_encrypted");

                    b.Property<byte[]>("LabName")
                        .IsRequired()
                        .HasColumnType("bytea")
                        .HasColumnName("lab_name_encrypted");

                    b.Property<string>("NablAccreditationId")
                        .HasMaxLength(50)
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_lab_technician_profiles_user_id");

                    b.ToTable("lab_technician_profiles", (string)null);
                });
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.Report", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("HardDeletedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("Extraction"), "gin");
                    NpgsqlIndexBuilderExtensions.HasOperators(b.HasIndex("Extraction"), new[] { "jsonb_path_ops" });
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<byte[]>("BloodGroup")
                        .HasColumnType("bytea")
                        .HasColumnName("blood_group_encrypted");
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.AadhaarVaultAccessLog", b =>
                {
                    b.HasOne("Aarogya.Domain.Entities.AadhaarVaultRecord", "AadhaarVaultRecord")
                        .WithMany("AccessLogs")
                        .HasForeignKey("ReferenceToken")
                        .HasPrincipalKey("ReferenceToken")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AadhaarVaultRecord");
                });
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.DoctorProfile", b =>
                {
                    b.HasOne("Aarogya.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Aarogya.Domain.Entities.DoctorProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Aarogya.Domain.Entities.LabTechnicianProfile", b =>
                {
                    b.HasOne("Aarogya.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Aarogya.Domain.Entities.LabTechnicianProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
